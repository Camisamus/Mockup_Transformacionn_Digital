                ...
                <div class="bg-white gob-card rounded-2xl overflow-hidden sticky top-32">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div class="space-y-3">
                            ...
                            <button type="button" onclick="abrirModalBusquedaFuncionario()" 
                        ...
                        <div class="overflow-x-auto">
                            <table class="w-full text-left" id="tabla_destinos">
                                ...
                                <tbody id="tbody_destinos" class="divide-y divide-slate-50"></tbody>
                            </table>
                        </div>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-2xl rounded-3xl overflow-hidden">
            ...
            <div class="modal-body p-4">
                <div class="mb-0">
                    <label for="textoNuevoComentario" class="text-[11px] font-bold text-slate-400 uppercase tracking-widest block mb-2">Su Comentario</label>
                    <textarea class="w-full border-slate-200 rounded-xl focus:ring-primary-blue text-sm p-3 bg-slate-50 italic" id="textoNuevoComentario" rows="4"
                        placeholder="Escriba aquí su comentario interno..."></textarea>
                </div>
            </div>
            <div class="modal-footer border-0 bg-light p-4">
                <button type="button" class="btn btn-link text-slate-400 text-decoration-none text-[11px] uppercase font-bold"
                    data-bs-dismiss="modal">Cancelar</button>
                <button type="button" class="bg-slate-800 hover:bg-black text-white px-6 py-2 rounded-xl text-[11px] font-bold uppercase shadow-lg transition-all" onclick="guardarComentario()">Guardar</button>
            </div>
        </div>
    </div>
</div>
