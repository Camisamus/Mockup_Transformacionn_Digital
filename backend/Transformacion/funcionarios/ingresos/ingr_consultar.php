    ...
    <div class="card shadow-sm border-0 mb-4 bg-white">
        <div class="card-body p-3">
            <div class="row g-2 justify-content-md-end">
                <div class="col-12 col-md-auto" id="col_ir_responder" style="display: none;">
                    <button type="button" class="btn btn-toolbar w-100" id="btn_ir_responder">
                ...
                <div class="col-12 col-md-auto" id="col_ir_preparar" style="display: none;">
                    <button type="button" class="btn btn-toolbar w-100" id="btn_ir_preparar">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <div class="col-12 col-md-auto" id="col_ir_modificar" style="display: none;">
                    <button type="button" class="btn btn-toolbar w-100" id="btn_ir_modificar">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <div class="col-12 col-md-auto">
                    <button type="button" class="btn btn-toolbar w-100 shadow-sm" onclick="location.href='index.php'">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
