    ...
    <div class="card shadow-sm border-0 mb-4 bg-white">
        <div class="card-body p-3">
            <div class="row g-2 justify-content-md-end">
                <!-- Dinamic Buttons Container -->
                <div class="col-12 col-md-auto d-flex gap-2" id="contenedor_acciones_card">
                ...
                <div class="col-12 col-md-auto" id="col_ir_preparar" style="display: none;">
                    <button type="button" class="btn btn-toolbar btn-dark w-100 shadow-sm" id="btn_ir_preparar">
...
<script src="../../recursos/js/funcionarios/ingresos/ingr_responder.js"></script>
