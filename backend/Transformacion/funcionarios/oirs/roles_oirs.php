...
<div class="container-fluid py-4">
    ...
    <div class="main-header mb-4">
        <div class="header-title">
            <h2 class="fw-bold fs-4">Gestión de Roles OIRS</h2>
            <p class="text-muted mb-0">Asignación de funcionarios a áreas y definición de jefaturas</p>
        </div>
    </div>
    ...
    <div class="card shadow-sm border-0 mb-4">
        <div class="card-body p-4">
            ...
            <p class="text-muted small mb-4">Filtrar por nombre de Funcionario o Área</p>
                ...
                <table class="table table-hover align-middle small" id="tablaDatos">
                    <thead class="table-light text-uppercase">
                        <tr>
                            <th>Funcionario</th>
                            <th>Área</th>
                            <th class="text-center">Es Jefe</th>
        ...
        <div class="modal-content border-0 shadow-lg">
            ...
            <div class="modal-body p-4">
                <form id="main-form">
                    <div class="row g-3">
                        <div class="col-md-12">
                            <label class="form-label small fw-bold">Funcionario <span
                                    class="text-danger">*</span></label>
                            <select class="form-select form-select-sm select2" id="entry-funcionario" required
                                style="width: 100%;">
                        ...
                        <div class="col-md-12">
                            ...
                            <select class="form-select form-select-sm select2" id="entry-area" required
                                style="width: 100%;">
                        ...
                        <div class="col-md-12 mt-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="entry-jefe">
                                <label class="form-check-label fw-bold small" for="entry-jefe">¿Es Jefe del
                                    Área?</label>
                            </div>
                        </div>
                    </div>
...
<!-- Los modales de búsqueda se eliminan ya que usaremos select2 directamente -->
...
<script src="../../recursos/js/funcionarios/oirs/roles_oirs.js"></script>
