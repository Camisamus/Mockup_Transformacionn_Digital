...
<div class="max-w-[1400px] mx-auto p-4 lg:p-8 space-y-6">
    ...
    <div class="bg-white border border-slate-100 rounded-3xl p-6 lg:p-10 flex flex-col sm:flex-row justify-between items-center shadow-sm gap-6">
        <div class="space-y-1 w-full text-left">
            ...
            <p class="text-slate-400 text-sm lg:text-[15px] font-medium uppercase tracking-wider italic">Solicitudes OIRS pendiente de respuesta</p>
        </div>
    ...
    <!-- Contenedor dinámico para la tabla de OIRS -->
    <div id="tabla-resultados-oirs" class="space-y-6">
