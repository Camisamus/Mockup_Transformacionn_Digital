...
<div class="max-w-[1400px] mx-auto p-4 lg:p-8 space-y-6">
    ...
    <div class="bg-white border border-slate-100 rounded-3xl p-6 lg:p-10 flex flex-col sm:flex-row justify-between items-center shadow-sm gap-6">
        <div class="space-y-1 w-full text-left">
            <h1 class="text-2xl lg:text-3xl font-extrabold text-slate-800 tracking-tight">Listado OIRS</h1>
            <p class="text-slate-400 text-sm lg:text-[15px] font-medium uppercase tracking-wider">Gestión de Solicitudes Municipales</p>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-6 items-end">
                <div class="md:col-span-4 space-y-2">
                    ...
                    <div class="relative flex items-center">
                        ...
                        <input type="text" class="form-control-cool w-full pl-10 pr-4 py-2.5 rounded-xl border-slate-200 focus:ring-primary-blue text-sm bg-slate-50/50" placeholder="Escribe para buscar...">
                    </div>
                </div>
                <div class="md:col-span-3 space-y-2">
                    <label class="text-[11px] font-bold text-slate-400 uppercase tracking-widest">Fecha de Ingreso</label>
                    <input type="date" class="form-control-cool w-full px-4 py-2.5 rounded-xl border-slate-200 focus:ring-primary-blue text-sm">
                </div>
                <div class="md:col-span-3 space-y-2">
                    <label class="text-[11px] font-bold text-slate-400 uppercase tracking-widest">Estado de la Solicitud</label>
                    <select class="form-control-cool w-full px-4 py-2.5 rounded-xl border-slate-200 focus:ring-primary-blue text-sm">
    ...
    <div class="bg-white border border-slate-100 rounded-xl shadow-sm overflow-hidden min-h-[400px]">
        <div class="p-4 border-b border-slate-50 bg-white">
            <h3 class="font-bold text-slate-700 uppercase text-xs tracking-widest flex items-center gap-2">
                <span class="material-symbols-outlined text-primary-blue">list_alt</span> Resultados de Búsqueda
            </h3>
        </div>
...
<script>
    $(document).ready(function () {
        // Toggle Filtros Avanzados (Funcionalidad original adaptada)
        $('#btnAdvanced').on('click', function () {
            const $panel = $('#advancedPanel');
            const $btn = $(this);
            $panel.toggleClass('show');
            $btn.toggleClass('bg-primary-blue text-white active');
...
<script>
    $(document).ready(function () {
        // Inicialización original del listado
