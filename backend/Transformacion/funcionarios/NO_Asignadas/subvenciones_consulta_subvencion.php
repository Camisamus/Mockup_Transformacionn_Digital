<?php
$pageTitle = "Consulta de Subvenci�n";
...
<div class="container-fluid py-4">
    ...
    <div class="main-header mb-4">
        <div class="header-title">
            <h2 class="fw-bold fs-4">Consulta de Subvenci�n</h2>
            <p class="text-muted mb-0">B�squeda, creaci�n y modificaci�n de subvenciones</p>
        </div>
    </div>
    ...
    <!-- Datos de la Subvenci�n -->
    <div class="card shadow-sm border-0 mb-4">
        <div class="card-body p-4">
            <h3 class="h6 fw-bold mb-1">Informaci�n de la Subvenci�n</h3>
            <p class="text-muted small mb-4">Complete los datos de la subvenci�n</p>
            ...
            <form id="formSubvencion" onsubmit="event.preventDefault(); guardarSubvencion();">
                <div class="row g-3">
                    ...
                    <!-- Row 2 -->
                    <div class="col-md-4">
                        <label for="tipo_subvencion" class="form-label small fw-bold">Tipo de Subvenci�n</label>
                    ...
                    <div class="col-md-4">
                        <label for="rut_organizacion" class="form-label small fw-bold">RUT Organizaci�n <span
                                class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="rut_organizacion" placeholder="XX.XXX.XXX-X"
                            required>
                    </div>
                    <div class="col-md-4">
                        <label for="nombre_organizacion" class="form-label small fw-bold">Nombre Organizaci�n <span
                                class="text-danger">*</span></label>
                    ...
                    <div class="col-md-4">
                        <label for="anio" class="form-label small fw-bold">A�o</label>
                        <input type="number" class="form-control" id="anio" placeholder="2024" min="2000" max="2100">
                    </div>

                    <!-- Row 4 -->
                    <div class="col-md-4">
                        <label for="anio_decreto" class="form-label small fw-bold">A�o de Decreto</label>
                    ...
                    <!-- Row 5 -->
                    <div class="col-md-6">
                        <label for="anio_matriz" class="form-label small fw-bold">A�o de Matriz</label>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="finalidad_proyecto"
                            placeholder="Descripci�n breve de la finalidad">
                    </div>

                    <!-- Row 6 - Objetivo de la Subvenci�n -->
                    <div class="col-12">
                        ...
                        <textarea class="form-control" id="objetivo_subvencion" rows="3"
                            placeholder="Describa el objetivo de la subvenci�n..."></textarea>
                    </div>
                </div>
            </form>
        </div>
