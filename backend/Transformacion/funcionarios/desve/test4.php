    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-2xl rounded-3xl overflow-hidden">
            <div class="bg-slate-50 p-6 border-b border-slate-100">
                <h5 class="font-bold text-slate-800 text-sm uppercase tracking-widest">Agregar Comentario</h5>
            </div>
            <div class="p-6">
                <textarea class="w-full rounded-2xl border-slate-200 focus:ring-primary-blue text-sm p-4" id="textoNuevoComentario" rows="4" placeholder="Escriba aquí..."></textarea>
            </div>
            <div class="p-6 bg-slate-50 border-t border-slate-100 flex justify-end gap-3">
                <button type="button" class="text-slate-400 font-bold text-xs uppercase" data-bs-dismiss="modal">Cerrar</button>
                <button type="button" class="bg-primary-blue text-white font-bold py-2.5 px-6 rounded-xl text-xs uppercase shadow-lg" onclick="guardarComentario()">Guardar</button>
            </div>
        </div>
    </div>
</div>
