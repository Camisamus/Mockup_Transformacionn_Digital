                ...
                <div class="card-body p-0">
                    <div class="list-group list-group-flush" id="tramiteList">
                        <a href="#" class="list-group-item list-group-item-action active font-weight-bold"
                            onclick="selectTramite(this)">Renovación de Licencia</a>
                        <a href="#" class="list-group-item list-group-item-action text-dark"
                            onclick="selectTramite(this)">Obtención Primera Licencia</a>
                        <a href="#" class="list-group-item list-group-item-action text-dark"
                            onclick="selectTramite(this)">Control 6 Años</a>
                        <a href="#" class="list-group-item list-group-item-action text-dark"
                            onclick="selectTramite(this)">Duplicado</a>
                        <a href="#" class="list-group-item list-group-item-action text-dark"
                            onclick="selectTramite(this)">Cambio de Clase</a>
                    </div>
                </div>
        ...
        <div class="col-md-8">
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-header bg-white border-bottom py-3 d-flex justify-content-between align-items-center">
                    <h6 class="font-weight-bold text-dark mb-0">Reglas de Disponibilidad - <span class="text-primary"
                            id="tramiteTitle">Renovación de Licencia</span></h6>
                        ...
                        <table class="table table-hover mb-0" style="font-size: 13px;">
                            <thead class="bg-light">
                                <tr>
                                    ...
                                    <th class="border-0 font-weight-bold text-muted text-uppercase py-3 text-center">3ra
                                        Edad</th>
                                    ...
                                    <th class="border-0 font-weight-bold text-muted text-uppercase py-3 text-center">
                                        Otros</th>
                                    <th
                                        class="border-0 font-weight-bold text-muted text-uppercase py-3 text-right pr-4">
                                        Acciones</th>
                                </tr>
                            </thead>
                            <tbody id="rulesTable">
                                <!-- Regla 1 -->
                                <tr>
                                    <td class="align-middle pl-4"><span class="badge badge-light border">Lu-Vi</span>
                                    </td>
                                    ...
                                    <td class="align-middle text-right pr-4">
                                        <button class="btn btn-link text-primary p-0 mr-2"><span
                                                class="material-symbols-outlined"
                                                style="font-size: 18px;">edit</span></button>
                                        <button class="btn btn-link text-danger p-0"><span
                                                class="material-symbols-outlined"
            ...
            <div class="alert alert-info border-0 d-flex align-items-center mb-0">
                ...
                <div>
                    <strong>Nota:</strong> Los horarios como las 12:00, que no aparecen en esta lista, no tendrán cupos
                    disponibles para el trámite "Renovación de Licencia".
                </div>
            </div>
