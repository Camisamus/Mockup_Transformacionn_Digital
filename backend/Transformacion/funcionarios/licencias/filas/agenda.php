...
<div class="container-fluid p-4">
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-header bg-white border-bottom py-3 d-flex justify-content-between align-items-center cursor-pointer"
            data-toggle="collapse" data-target="#collapse0900">
                ...
                <div class="table-responsive">
                    <table class="table table-hover mb-0" style="font-size: 13px;">
                        <thead class="bg-light">
                            <tr>
                                <th class="border-0 font-weight-bold text-muted text-uppercase py-3 pl-4">Nombre
                                    Completo</th>
                                ...
                                <th class="border-0 font-weight-bold text-muted text-uppercase py-3 text-center">Estado
                                </th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle text-right pr-4">
                                    <button class="btn btn-sm btn-success font-weight-bold px-3"
                                        onclick="marcarAsistencia(this)">Check-in</button>
                                    <button class="btn btn-sm btn-outline-danger font-weight-bold ml-1"
                                        onclick="marcarAusente(this)">No Show</button>
                                </td>
                            </tr>
                            <!-- Persona 3 -->
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-header bg-white border-bottom py-3 d-flex justify-content-between align-items-center cursor-pointer"
            data-toggle="collapse" data-target="#collapse1000">
            <div class="d-flex align-items-center">
                <span class="badge badge-secondary px-3 py-2 mr-3 font-weight-bold"
                    style="font-size: 14px;">10:00</span>
                <div>
...
<script src="../../../recursos/js/funcionarios/licencias/filas/agenda.js"></script>
