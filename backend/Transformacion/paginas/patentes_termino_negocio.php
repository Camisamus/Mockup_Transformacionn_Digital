<?php
$pageTitle = "Solicitud de Término de Negocio";
...
?>
    ...
    <div class="container-fluid">
        <h3 class="mb-4">Solicitud de Término de Negocio</h3>
        ...
        <div id="form-container">
            ...
            <div class="section-card">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <label class="form-label">Dirección (Calle, NÂ°, Población)</label>
                ...
                <div class="row g-2">
                    <div class="col-md-6">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="adjPatente">Fotocopia simple última Patente pagada (al
                                día).</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="adjTerminoGiro">Término de Giro / Cierre Sucursal
                                (S.I.I.).</label>
                        </div>
                    </div>
                    <div class="col-md-6">
