...
?>
            ...
            <div class="modal-content border-0 shadow-lg">
                ...
                <div class="modal-body p-4">
                    <form id="main-form">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label class="form-label small fw-bold">Usuario <span
    ...
    <script src="../recursos/js/sisadmin_mantenedor_acceso_usuarios_perfiles.js"></script>
