...
?>
    ...
    <div class="container-fluid">
        <h3 class="mb-4">Solicitud de Cambio de Nombre</h3>
        ...
        <div id="form-container">
            ...
            <div class="section-card">
                ...
                <div class="row g-2">
                    <div class="col-md-6">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="docPatente">Fotocopia simple de última(s) patenete(s)
                                pagada(s).</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="docCedula">Fotocopia Cédula de Identidad.</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="subsection-header">Persona Jurídica</div>
                        <div class="form-check">
                ...
                <div class="subsection-header text-primary mt-3">Requisitos Específicos por Giro</div>
                <div class="row g-2">
                    <div class="col-12">
                        <div class="form-check">
                ...
                <div class="row g-2">
                    <div class="col-12">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="docAlcohol">Cert. Antecedentes y DJ Art. 4Â° Ley 19.925
                                (Alcoholes).</label>
                        </div>
                    </div>
                    <div class="col-12">
