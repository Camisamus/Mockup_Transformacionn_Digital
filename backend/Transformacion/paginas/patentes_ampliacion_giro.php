...
?>
    ...
    <div class="container-fluid">
        <h3 class="mb-4">Solicitud de Ampliación de Giro y/o Cambio de Giro</h3>
        ...
        <div id="form-container">
                ...
                <div class="d-flex">
                    ...
                    <div>
                        ...
                        <ul class="mb-0 small">
                            ...
                            <li>Podrán ser requeridos otros documentos no mencionados para giros específicos.</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="section-card">
                ...
                <div class="row g-2">
                    <div class="col-md-6">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="docPatente">Fotocopia simple de última(s) Patente(s)
                                pagada(s).</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="docContribuciones">Fotocopia Recibo Contribuciones o NÂ°
                                Rol Avalúo.</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="subsection-header mt-3">Específica del Establecimiento</div>
                <div class="row g-2">
                    <div class="col-md-12">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="docFotos">
                            <label class="form-check-label" for="docFotos">2 Fotografías del establecimiento (interior y
                                exterior).</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="docTecnico">Certificado Técnico Urbanístico.</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-check">
