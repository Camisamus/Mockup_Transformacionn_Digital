<?php
$pageTitle = "Mantenedor Orígenes Especiales";
...
?>
    ...
    <div class="container-fluid py-4">
        ...
        <div class="main-header mb-4">
            <div class="header-title">
                <h2 class="fw-bold fs-4">Mantenedor de Orígenes Especiales</h2>
                <p class="text-muted mb-0">Gestión de organizaciones externas y entidades públicas relacionadas</p>
            </div>
            <div class="toolbar">
                ...
                <button class="btn btn-toolbar btn-dark" id="btn-new-origin">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-body p-4">
                ...
                <p class="text-muted small mb-4">Refine el listado de orígenes por nombre o tipo</p>
        ...
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h5 class="fw-bold fs-6 mb-0">Listado de Orígenes</h5>
                </div>
    ...
    <script src="../recursos/js/sisadmin_mantenedor_desve_oigenesespeciales.js"></script>
