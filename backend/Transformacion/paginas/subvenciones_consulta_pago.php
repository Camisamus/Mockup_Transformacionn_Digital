...
?>
    ...
    <div class="container-fluid py-4">
        ...
        <div class="main-header mb-4">
            ...
            <div class="toolbar">
                <button class="btn btn-toolbar" onclick="buscarPago()">
                ...
                <button class="btn btn-toolbar" onclick="nuevoPago()">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="card shadow-sm border-0 mb-4 mx-auto" id="datos_pago_card" style="display: none; max-width: 800px;">
            <div class="card-body p-4">
                ...
                <form id="formPago" onsubmit="event.preventDefault(); guardarCambios();">
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label for="pago_numero" class="form-label small fw-bold">Número Subvención</label>
    ...
    <script src="../recursos/js/subvenciones_consulta_pago.js"></script>
