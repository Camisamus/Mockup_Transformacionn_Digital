...
?>
    ...
    <div class="container-fluid py-4">
        ...
        <div class="main-header mb-4">
            <div class="header-title">
                ...
                <p class="text-muted mb-0">Gestión de vínculos entre perfiles de usuario y roles del sistema</p>
            </div>
            <div class="toolbar">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control form-control-sm" id="filter-text"
                            placeholder="Ej: Administrador o Pagos...">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content border-0 shadow-lg">
                ...
                <div class="modal-body p-4">
                    <form id="main-form">
                        <div class="row g-3">
                            <div class="col-md-12">
                                <label class="form-label small fw-bold">Perfil <span
                            ...
                            <div class="col-md-12">
                                <label class="form-label small fw-bold">Categoría <span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="col-md-12">
                                ...
                                <div id="roles-checkbox-container" class="border rounded p-3 bg-white"
                                    ...
                                    <p class="text-muted small mb-0">Seleccione una categoría para ver los roles.</p>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="modal-footer bg-light border-0">
                    ...
                    <button type="button" class="btn btn-dark px-4 shadow-sm" id="btn-save">Vincular</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="../recursos/js/sisadmin_mantenedor_acceso_perfiles_roles.js"></script>
