...
?>
    ...
    <div class="container-fluid">
        <h3 class="mb-4">Solicitud de Revisión Cobro de Patente</h3>
        ...
        <div id="form-container">
                ...
                <div class="row g-2">
                    <div class="col-md-6">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="motivoCalculo">Cálculo de Patente</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-check">
                    ...
                    <div class="col-md-6">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="motivoPropaganda">Cálculo Propaganda</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-check">
            ...
            <div class="section-card">
                ...
                <div class="alert alert-light border small text-muted mb-3">
                    <strong>Requisito General:</strong> Se debe adjuntar Fotocopia de la(s) última(s) Patente(s)
                    Cancelada(s).
                </div>
                ...
                <div class="row g-3 align-items-center mb-2">
                    ...
                    <div class="col-auto">
                        <input type="text" class="form-control form-control-sm"
                            placeholder="Indicar Años (ej: 2023, 2024)" id="aniosRenta">
                    </div>
                </div>
