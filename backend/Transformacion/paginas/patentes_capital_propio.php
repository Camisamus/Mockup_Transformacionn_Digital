...
?>
    ...
    <div class="container-fluid">
        <h3 class="mb-4">Solicitud de Certificado de Distribución de Capital Propio</h3>
            ...
            <div class="header-box mb-4">
                ...
                <div class="row g-3 mt-2">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="ingreso" placeholder="NÂ° de Ingreso">
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 border-start">
                        <div class="mt-4 ps-md-3">
                            ...
                            <div class="mb-3">
                                <label class="form-label small">Número de Folio</label>
