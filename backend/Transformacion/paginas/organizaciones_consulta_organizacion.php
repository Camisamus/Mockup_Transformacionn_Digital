...
?>
    ...
    <div class="container-fluid py-4">
        ...
        <div class="main-header mb-4">
            ...
            <div class="toolbar">
                <button class="btn btn-toolbar" onclick="buscarOrganizacion()">
                ...
                <button class="btn btn-toolbar" onclick="editarFormulario()">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <button class="btn btn-toolbar" onclick="generarCertificado()">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <button class="btn btn-toolbar btn-dark " onclick="guardarCambios()">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <form id="formOrganizacion">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="registro" placeholder="Número de registro">
                        </div>
                        <div class="col-md-4">
                            <label for="folio" class="form-label small fw-bold">Folio</label>
                            <input type="number" class="form-control" id="folio" placeholder="Número de folio">
                        </div>
                        ...
                        <div class="col-md-6">
                            <label for="numeroSocios" class="form-label small fw-bold">Número de Socios</label>
                            <input type="number" class="form-control" id="numeroSocios"
                                placeholder="Cantidad de socios">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-body p-4">
                    ...
                    <p class="text-muted small mb-4">Información sobre el propósito y áreas de especialización</p>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label for="fechaTermino" class="form-label small fw-bold">Fecha de Término de
                                Vigencia</label>
                    ...
                    <div class="card shadow-sm border-0 mb-4 h-100">
                        <div class="card-body p-4">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    <label for="domNumero" class="form-label small fw-bold">Número</label>
            ...
            <div class="d-flex justify-content-end gap-2 mb-5">
                <button type="button" class="btn btn-outline-secondary px-4 shadow-sm" onclick="limpiarFormulario()">
                    Limpiar
                </button>
                <button type="button" class="btn btn-primary px-4 shadow-sm" onclick="guardarCambios()">
    ...
    <script src="../recursos/js/organizaciones_consulta_organizacion.js"></script>
