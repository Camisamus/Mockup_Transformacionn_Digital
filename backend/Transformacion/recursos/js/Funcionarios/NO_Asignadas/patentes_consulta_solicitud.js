...
function searchSolicitud() {
    ...
    if (!searchId && !searchTramitador) {
        Swal.fire('Atención', 'Por favor ingrese un ID de solicitud o un tramitador', 'warning');
        return;
    }
...
function displaySolicitud(solicitud) {
    ...
    if (actionsCard) actionsCard.classList.remove('d-none');
...
function showNoResults() {
    ...
    // Hide Actions Card
    const actionsCard = document.getElementById('actionsCard');
    if (actionsCard) actionsCard.classList.add('d-none');
