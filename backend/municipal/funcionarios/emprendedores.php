...
<div class="flex-1 overflow-y-auto custom-scrollbar p-6">
    <div class="max-w-7xl mx-auto space-y-6">
        ...
        <div class="flex flex-col gap-2 mb-8">
            <h1 class="text-[#111418] dark:text-white text-4xl font-black leading-tight tracking-[-0.033em]">Gestión de
                Emprendedores</h1>
            <p class="text-[#617589] dark:text-gray-400 text-base font-normal">Monitoreo de desempeño, participación y
                cumplimiento del programa municipal de Viña del Mar.</p>
        </div>
        <!-- KPI Stats Section -->
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
            <!-- KPI 1: Promedio de Evaluación -->
            <div
                class="flex flex-col gap-3 rounded-xl p-8 bg-white dark:bg-gray-800 border border-[#dbe0e6] dark:border-gray-700 shadow-sm relative overflow-hidden group">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <p class="text-[#617589] dark:text-gray-400 text-sm font-semibold uppercase tracking-wider">Promedio
                        de Evaluación</p>
                </div>
                ...
                <div
                    class="flex items-center gap-2 text-[#078838] bg-green-50 dark:bg-green-900/20 px-2 py-1 rounded w-fit">
            ...
            <div
                ...
                <div class="flex items-center gap-2">
                    ...
                    <p class="text-[#617589] dark:text-gray-400 text-sm font-semibold uppercase tracking-wider">Índice
                        de Asistencia</p>
                </div>
                <div class="flex items-baseline gap-3">
        ...
        <div class="flex flex-col md:flex-row justify-between items-end md:items-center mb-6 gap-4">
            <h2 class="text-[#111418] dark:text-white text-2xl font-bold leading-tight tracking-[-0.015em]">Listado de
                Emprendedores Inscritos</h2>
            <div class="flex gap-2 p-1 bg-gray-100 dark:bg-gray-800 rounded-lg">
                <button
                    class="flex h-9 items-center justify-center gap-x-2 rounded-md bg-white dark:bg-gray-700 px-4 shadow-sm">
                    <p class="text-primary text-sm font-bold leading-normal">Todos</p>
                </button>
                <button
                    class="flex h-9 items-center justify-center gap-x-2 rounded-md px-4 hover:bg-white/50 dark:hover:bg-gray-600 transition-all">
        ...
        <!-- Main Data Table -->
        <div
            class="bg-white dark:bg-gray-800 rounded-xl border border-[#dbe0e6] dark:border-gray-700 overflow-hidden shadow-sm">
            <div class="overflow-x-auto">
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr
                            class="bg-background-light dark:bg-gray-900/50 text-[#617589] dark:text-gray-400 text-sm font-bold uppercase tracking-wider">
                    ...
                    <tbody class="divide-y divide-[#f0f2f4] dark:divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors group">
                            ...
                            <td class="px-6 py-5">
                                <span
                                    class="px-3 py-1 bg-blue-50 dark:bg-blue-900/30 text-primary text-xs font-bold rounded-full">Artesanía</span>
                            </td>
                            <td class="px-6 py-5">
                            ...
                            <td class="px-6 py-5 text-center">
                                <a href="emprendedores-detalle.php"
                                    class="bg-primary hover:bg-primary/90 text-white px-4 py-2 rounded-lg text-sm font-bold transition-all inline-flex items-center gap-2">
                                    <span>Ver</span>
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors group">
                            ...
                            <td class="px-6 py-5">
                                <span
                                    class="px-3 py-1 bg-orange-50 dark:bg-orange-900/30 text-orange-600 dark:text-orange-400 text-xs font-bold rounded-full">Gastronomía</span>
                            </td>
                            <td class="px-6 py-5">
                                <div class="flex text-yellow-500">
                                    <span class="material-symbols-outlined fill-icon text-lg">star</span>
                                    ...
                                    <span class="material-symbols-outlined fill-icon text-lg">star</span>
                                    <span
                                        class="material-symbols-outlined fill-icon text-lg text-primary/30">star</span>
                                </div>
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors group">
                            ...
                            <td class="px-6 py-5">
                                <span
                                    class="px-3 py-1 bg-purple-50 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400 text-xs font-bold rounded-full">Textil</span>
                            </td>
                            <td class="px-6 py-5">
                                <div class="flex text-yellow-500">
                                    <span class="material-symbols-outlined fill-icon text-lg">star</span>
            ...
            <div
                class="px-6 py-4 flex items-center justify-between border-t border-[#f0f2f4] dark:border-gray-700 bg-background-light/30 dark:bg-gray-800/50">
                <p class="text-sm text-[#617589] dark:text-gray-400">Mostrando 4 de 128 emprendedores</p>
                <div class="flex gap-2">
                    <button
                        class="p-2 border border-[#dbe0e6] dark:border-gray-700 rounded hover:bg-white dark:hover:bg-gray-700 transition-colors disabled:opacity-50"
                        disabled="">
                        <span class="material-symbols-outlined">chevron_left</span>
                    </button>
                    <button
                        class="p-2 border border-[#dbe0e6] dark:border-gray-700 rounded hover:bg-white dark:hover:bg-gray-700 transition-colors">
