                    ...
                    <div class="card-body p-4">
                        <div class="row">
                            <div class="col-md-8 mb-3">
                                <label class="small font-weight-bold text-muted text-uppercase">Título /
                                    Referencia</label>
                                <input type="text" class="form-control"
                                    placeholder="Ej: Solicitud de Compra Insumos Computacionales">
                            </div>
                        ...
                        <div class="mb-3">
                            <label class="small font-weight-bold text-muted text-uppercase">Contenido /
                                Providencia</label>
                            <textarea class="form-control" rows="8"
                                placeholder="Escriba el contenido del documento o la instrucción de la providencia..."></textarea>
                            <small class="text-muted">Este texto servirá como el cuerpo principal del documento
                                digital.</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body p-4">
                        <div class="form-group mb-4">
                            <label class="small font-weight-bold text-muted text-uppercase">Documento Principal
                                (PDF)</label>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="customFileAnexos" multiple
                                    accept="application/pdf">
                                <label class="custom-file-label" for="customFileAnexos">Seleccionar anexos
                                    PDF...</label>
                            </div>
                        </div>
                        ...
                        <div class="mb-2">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <label class="small font-weight-bold text-muted text-uppercase mb-0">Enlaces
                                    Externos</label>
                                <button type="button" class="btn btn-link btn-sm p-0 font-weight-bold"
                                    onclick="addLinkRow()">
                                    <span class="material-symbols-outlined align-middle"
                                        style="font-size: 16px;">add</span> Agregar Enlace
                                </button>
                            </div>
        ...
        <div class="card-body p-3">
            <div class="d-flex justify-content-between align-items-start mb-2">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <span class="font-weight-bold d-block text-dark recipient-name" style="font-size: 13px;">Nombre
                            Funcionario</span>
                ...
                <div class="col-12 mb-2">
                    <div class="btn-group btn-group-toggle w-100" data-toggle="buttons">
                        <label class="btn btn-white border btn-sm active shadow-none">
                            <input type="radio" name="role_uid" value="responsable" onchange="toggleRole(this)" checked>
                            Responsable
                        </label>
