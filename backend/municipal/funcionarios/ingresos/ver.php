    ...
    <div class="d-flex align-items-center justify-content-between">
        <div class="d-flex flex-column">
            ...
            <p class="text-primary font-weight-bold text-uppercase mb-0"
                style="font-size: 9px; letter-spacing: 0.15em;">Gestión Documental Digital</p>
        </div>
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body p-4">
                    <div class="row mb-4">
                        <div class="col-md-8">
                            <label class="small font-weight-bold text-muted text-uppercase mb-1">Título /
                                Referencia</label>
                            <p class="h6 text-dark font-weight-bold">Solicitud de Compra Insumos Computacionales -
                                Depto. Tránsito</p>
                        </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-4">
                            <label class="small font-weight-bold text-muted text-uppercase mb-1">Tipo de
                                Documento</label>
                    ...
                    <div class="bg-light p-4 rounded mb-4">
                        <label class="small font-weight-bold text-muted text-uppercase mb-2">Contenido /
                            Providencia</label>
                        <p class="text-dark mb-0" style="white-space: pre-line; font-size: 14px;">
                            Estimado Alcalde,

                            Junto con saludar, solicito a usted autorizar la compra de 5 computadores All-in-One para el
                            departamento de tránsito, debido a la obsolescencia de los equipos actuales.
                    ...
                    <div class="row">
                            ...
                            <div class="card p-2 border shadow-sm">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column overflow-hidden">
                                        <a href="#"
                                            class="small font-weight-bold text-truncate text-dark stretched-link">Memo_8851.pdf</a>
                        ...
                        <div class="col-md-4 mb-2">
                            <div class="card p-2 border shadow-sm">
                                <div class="d-flex align-items-center">
                                    <span class="material-symbols-outlined text-muted mr-2"
                                        style="font-size: 32px;">attachment</span>
                                    <div class="d-flex flex-column overflow-hidden">
                                        <a href="#"
                                            class="small font-weight-bold text-truncate text-dark stretched-link">Cotizaciones_MP.pdf</a>
                            ...
                            <div class="card p-2 border shadow-sm">
                                <div class="d-flex align-items-center">
                                    <span class="material-symbols-outlined text-primary mr-2"
                                        style="font-size: 32px;">link</span>
                                    <div class="d-flex flex-column overflow-hidden">
                                        <a href="#"
                                            class="small font-weight-bold text-truncate text-dark stretched-link">Enlace
                                            a Mercado Público</a>
                    ...
                    <form>
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows="5"
                                placeholder="Redacte su respuesta o informe técnico aquí..."></textarea>
                        </div>
                        <div class="form-group">
                            <label class="small font-weight-bold text-muted text-uppercase">Adjuntar Respuesta
                                (Opcional)</label>
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item d-flex align-items-center">
                            ...
                            <div class="flex-grow-1">
                                <span class="d-block font-weight-bold text-dark" style="font-size: 13px;">Juan Pérez
                                    (Operaciones)</span>
                        ...
                        <li class="list-group-item d-flex align-items-center bg-light">
                            ...
                            <div class="flex-grow-1">
                                <span class="d-block font-weight-bold text-dark" style="font-size: 13px;">Ud.
                                    (Administración)</span>
                            ...
                            <button class="btn btn-sm btn-success py-0 px-2" style="font-size: 11px;"
                                onclick="visarDocumento()">Visar</button>
                        </li>
                        <li class="list-group-item d-flex align-items-center text-muted" style="opacity: 0.6;">
                            ...
                            <div class="flex-grow-1">
                                <span class="d-block font-weight-bold" style="font-size: 13px;">Ana Ruiz
                                    (Jurídica)</span>
                ...
                <div class="card-body p-0">
                    <div class="accordion" id="accordionSubtareas">
                        ...
                        <div class="card border-0 border-bottom rounded-0">
                            <div class="card-header bg-white p-3" id="headingSub1" data-toggle="collapse"
                                data-target="#collapseSub1" aria-expanded="true" style="cursor: pointer;">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="d-flex align-items-center">
                                        <span class="material-symbols-outlined text-muted mr-2"
                                            style="font-size: 18px;">subdirectory_arrow_right</span>
                                        <div>
                                            <span class="font-weight-bold d-block text-dark"
                                                style="font-size: 12px;">Consultar Stock Bodega</span>
                            ...
                            <div id="collapseSub1" class="collapse" aria-labelledby="headingSub1"
                                data-parent="#accordionSubtareas">
                                <div class="card-body bg-light p-3 small">
                                    ...
                                    <a href="#" class="text-primary font-weight-bold"><span
                                            class="material-symbols-outlined align-middle"
                                            style="font-size: 14px;">attachment</span> informe_bodega.pdf</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card border-0 rounded-0">
                            <div class="card-header bg-white p-3" id="headingSub2" data-toggle="collapse"
                                data-target="#collapseSub2" aria-expanded="false" style="cursor: pointer;">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="d-flex align-items-center">
                                        <span class="material-symbols-outlined text-muted mr-2"
                                            style="font-size: 18px;">subdirectory_arrow_right</span>
                                        <div>
                                            <span class="font-weight-bold d-block text-dark"
                                                style="font-size: 12px;">Validar Presupuesto</span>
                            ...
                            <div id="collapseSub2" class="collapse" aria-labelledby="headingSub2"
                                data-parent="#accordionSubtareas">
                                <div class="card-body bg-light p-3 small">
