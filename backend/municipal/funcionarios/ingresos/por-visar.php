    ...
    <div class="d-flex align-items-center justify-content-between">
        <div class="d-flex flex-column">
            ...
            <p class="text-primary font-weight-bold text-uppercase mb-0"
                style="font-size: 9px; letter-spacing: 0.15em;">Gestión de Firmas Pendientes</p>
        </div>
                ...
                <thead class="bg-light">
                    <tr>
                        ...
                        <th class="border-0 font-weight-bold text-muted text-uppercase py-3 text-right pr-4"
                            style="font-size: 11px;">Acción</th>
                    </tr>
                </thead>
                <tbody>
                    <!-- Item 1 -->
                    <tr class="bg-white clickable-row" data-href="ver.php">
                        ...
                        <td class="align-middle">
                            <div class="d-flex flex-column">
                                ...
                                <span class="text-muted text-truncate" style="max-width: 350px;">Memorándum: Solicitud
                                    de Compra Insumos Computacionales</span>
                            </div>
                        </td>
                        <td class="align-middle">
                        ...
                        <td class="align-middle text-right pr-4">
                            <button class="btn btn-sm btn-success px-3 font-weight-bold"
                                onclick="event.stopPropagation(); visarDocumento()">Visar</button>
                        </td>
                    </tr>
                    ...
                    <tr class="bg-white clickable-row" data-href="ver.php">
                        ...
                        <td class="align-middle">
                            <div class="d-flex flex-column">
                                ...
                                <span class="text-muted text-truncate" style="max-width: 350px;">Oficio: Respuesta a
                                    Contraloría sobre Auditoría Interna</span>
                            </div>
                        </td>
                        <td class="align-middle">
                            <div class="d-flex align-items-center">
                    ...
                    <tr class="bg-white clickable-row" data-href="ver.php">
                        ...
                        <td class="align-middle">
                            <div class="d-flex flex-column">
                                ...
                                <span class="text-muted text-truncate" style="max-width: 350px;">Solicitud: Permiso
                                    Administrativo Funcionario</span>
                            </div>
                        </td>
                        <td class="align-middle">
                            <div class="d-flex align-items-center">
                                <div class="bg-light rounded-circle d-flex align-items-center justify-content-center mr-2 text-primary font-weight-bold"
                                    style="width: 28px; height: 28px; font-size: 10px;">PT</div>
