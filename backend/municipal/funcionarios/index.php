...
<header class="bg-white border-bottom shadow-sm px-4 d-flex align-items-center justify-content-between"
    style="height: 70px; border-bottom: 3px solid var(--gob-primary) !important; flex-shrink: 0; z-index: 10;">
    <div class="d-flex align-items-center" style="gap: 1rem;">
        ...
        <div class="d-flex flex-column">
            ...
            <p class="text-primary font-weight-bold text-uppercase mb-0"
                style="font-size: 9px; letter-spacing: 0.15em; margin-top: 2px;">Sistema Unificado de Gestión Municipal
            </p>
        </div>
    </div>
    <div class="d-flex align-items-center" style="gap: 1rem;">
        ...
        <button class="btn btn-light btn-sm rounded-circle p-2 border-0 shadow-none position-relative">
            ...
            <span class="position-absolute bg-danger border border-white rounded-circle"
                style="top: 8px; right: 8px; width: 8px; height: 8px;"></span>
        </button>
    </div>
</header>
                    ...
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <p class="text-muted font-weight-bold text-uppercase mb-1"
                                style="font-size: 10px; letter-spacing: 0.1em;">Total Organizaciones</p>
                            <h3 class="h4 font-serif font-bold text-dark mb-0">1,284</h3>
                        </div>
                        <div class="bg-light p-2 rounded text-primary border d-flex align-items-center justify-content-center"
            ...
            <div class="card h-100 border-0 shadow-sm stat-card">
                <div class="card-body d-flex flex-column justify-content-between">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <p class="text-muted font-weight-bold text-uppercase mb-1"
                                style="font-size: 10px; letter-spacing: 0.1em;">Uso de Plazas</p>
                            <h3 class="h4 font-serif font-bold text-dark mb-0">85%</h3>
                        </div>
                        <div class="bg-light p-2 rounded text-success border d-flex align-items-center justify-content-center"
                            style="width: 42px; height: 42px;">
            ...
            <div class="card h-100 border-0 shadow-sm stat-card">
                <div class="card-body d-flex flex-column justify-content-between">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <p class="text-muted font-weight-bold text-uppercase mb-1"
                                style="font-size: 10px; letter-spacing: 0.1em;">Solicitudes Nuevas</p>
                            <h3 class="h4 font-serif font-bold text-dark mb-0">42</h3>
                        </div>
                        <div class="bg-light p-2 rounded text-warning border d-flex align-items-center justify-content-center"
                            style="width: 42px; height: 42px;">
            ...
            <div class="card h-100 border-0 shadow-sm stat-card">
                <div class="card-body d-flex flex-column justify-content-between">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <p class="text-muted font-weight-bold text-uppercase mb-1"
                                style="font-size: 10px; letter-spacing: 0.1em;">Participantes</p>
                            <h3 class="h4 font-serif font-bold text-dark mb-0">15.4k</h3>
                        </div>
                        <div class="bg-light p-2 rounded text-info border d-flex align-items-center justify-content-center"
                            style="width: 42px; height: 42px;">
            ...
            <div class="card border-0 shadow-sm mb-4" style="border-radius: 8px;">
                <div class="card-header bg-white border-bottom p-4 d-flex align-items-center justify-content-between">
                    ...
                    <span class="badge badge-light border text-muted px-2"
                        style="font-size: 9px; font-weight: bold;">Recientes</span>
                </div>
                <div class="card-body p-4">
                    <div class="d-flex align-items-start mb-0">
                        <div class="bg-light border text-primary rounded-circle d-flex align-items-center justify-content-center mr-3"
                            style="width: 32px; height: 32px; flex-shrink: 0;">
                            <span class="material-symbols-outlined" style="font-size: 16px;">chat</span>
                        </div>
                        <div>
                            <p class="font-weight-bold text-dark mb-1" style="font-size: 12px;">Validación pendiente</p>
                            <p class="text-muted mb-2" style="font-size: 11px; line-height: 1.4;">Sector Gómez Carreño
                                requiere revisión de personalidad jurídica.</p>
                            <p class="text-muted font-weight-bold text-uppercase mb-0"
                                style="font-size: 9px; opacity: 0.6;">Hace 15 min • J. Soto</p>
                        </div>
                    </div>
                </div>
            </div>
