            ...
            <div class="flex w-full flex-col gap-6 @[520px]:flex-row @[520px]:justify-between">
                <div class="flex gap-6">
                    ...
                    <div class="flex flex-col justify-center">
                        <h2 class="text-[#111418] dark:text-white text-2xl font-bold leading-tight">Artesanías Mar del
                            Plata</h2>
                        <div class="mt-2 space-y-1">
                            ...
                            <p class="text-[#617589] text-sm flex items-center gap-2">
                                <span class="font-semibold text-[#111418] dark:text-gray-300">Representante:</span> Juan
                                Pérez Soto
                            </p>
                        </div>
                    </div>
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="border-b border-[#f0f2f4] dark:border-[#2a343f]">
                            ...
                            <th class="py-3 px-4 text-xs font-bold uppercase tracking-wider text-[#617589]">Evento /
                                Plaza</th>
                            <th class="py-3 px-4 text-xs font-bold uppercase tracking-wider text-[#617589]">Estado</th>
                            <th class="py-3 px-4 text-xs font-bold uppercase tracking-wider text-[#617589] text-right">
                                Acciones</th>
                        </tr>
                    </thead>
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="border-b border-[#f0f2f4] dark:border-[#2a343f]">
                            ...
                            <th class="py-3 px-4 text-xs font-bold uppercase tracking-wider text-[#617589]">Asistencia
                            </th>
                            <th class="py-3 px-4 text-xs font-bold uppercase tracking-wider text-[#617589]">Nota Rúbrica
                            </th>
                            <th class="py-3 px-4 text-xs font-bold uppercase tracking-wider text-[#617589]">Comentarios
                            </th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-[#f0f2f4] dark:divide-[#2a343f]">
                        <tr class="hover:bg-background-light dark:hover:bg-[#2a343f] transition-colors">
                            ...
                            <td class="py-4 px-4 text-sm text-[#617589] italic">Excelente disposición y calidad del
                                producto...</td>
                        </tr>
                        <tr class="hover:bg-background-light dark:hover:bg-[#2a343f] transition-colors">
