    ...
    <div class="d-flex align-items-center" style="gap: 1.5rem;">
        ...
        <div class="d-flex flex-column">
            ...
            <p class="text-primary font-weight-bold text-uppercase mb-0"
                style="font-size: 10px; letter-spacing: 0.1em; margin-top: 4px;">Panel de Gestión Municipal</p>
        </div>
    </div>
        ...
        <div class="d-flex align-items-center" style="gap: 0.75rem;">
            <div class="d-flex" style="margin-left: 0.5rem;">
                <?php foreach ($quienes_votaron as $nombre): ?>
                        <div class="rounded-circle bg-light border border-white d-flex align-items-center justify-content-center font-weight-bold text-muted shadow-sm"
                            style="width: 32px; height: 32px; font-size: 10px; margin-left: -8px;"
            ...
            <span class="text-muted font-weight-bold text-uppercase"
                style="font-size: 10px; letter-spacing: 0.1em;">Participación: 5/10</span>
        </div>
        <a href="votar.php" class="btn btn-primary font-weight-bold py-2 px-4 shadow-sm"
            style="font-size: 11px; letter-spacing: 0.1em; border-radius: 0;">ACCESO VOTACIÓN</a>
    </div>
</header>
...
<div class="d-flex flex-grow-1 overflow-hidden">
    ...
    <aside class="bg-white border-right d-flex flex-column shadow-sm" style="width: 400px; flex-shrink: 0;">
        <div class="p-4 border-bottom">
            <div class="d-flex align-items-center justify-content-between mb-3">
                <h3 class="font-weight-bold text-dark text-uppercase mb-0"
                    style="font-size: 11px; letter-spacing: 0.15em;">Listado de Iniciativas</h3>
                <span class="badge badge-light border text-muted px-2 py-1"
                    style="font-size: 9px; font-weight: bold; border-radius: 0;"><?php echo count($proyectos); ?>
                    TOTAL</span>
            </div>
            <div class="position-relative">
                <span class="material-symbols-outlined position-absolute"
                    style="left: 12px; top: 10px; color: #94a3b8; font-size: 18px;">search</span>
                <input type="text" placeholder="Buscar por nombre o ID..."
                    class="form-control form-control-sm border-2 bg-light shadow-none"
                    style="padding-left: 40px; border-radius: 2px; font-size: 12px; height: 38px;">
            </div>
        </div>
        ...
        <div class="flex-grow-1 overflow-auto custom-scrollbar">
            <div class="list-group list-group-flush">
                <?php foreach ($proyectos as $p): ?>
                        <div
                            class="list-group-item list-group-item-action border-0 p-4 border-bottom project-card cursor-pointer transition-all">
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                <span class="text-muted font-weight-bold text-uppercase"
                                    style="font-size: 9px; letter-spacing: 0.2em;">ID:
                                    #<?php echo str_pad($p['id'], 3, '0', STR_PAD_LEFT); ?></span>
                            ...
                            <h4 class="h6 font-weight-bold text-dark mb-3 leading-snug project-title transition-all">
                                <?php echo $p['nombre']; ?></h4>
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center" style="gap: 0.5rem;">
                                    <span class="material-symbols-outlined text-muted" style="font-size: 16px;">payments</span>
                                    <span class="text-muted font-weight-bold text-uppercase"
                                        style="font-size: 10px;"><?php echo $p['presupuesto']; ?></span>
                                </div>
                                <div class="d-flex align-items-center" style="gap: 0.5rem;">
                                    <span class="material-symbols-outlined text-primary font-weight-bold"
                                        style="font-size: 16px;">how_to_vote</span>
                                    <span class="text-primary font-weight-bold text-uppercase"
                                        style="font-size: 10px;"><?php echo $p['votos']; ?> Votos</span>
                                </div>
                            </div>
                        </div>
                <?php endforeach; ?>
    ...
    <section class="flex-grow-1 d-flex flex-column overflow-hidden" style="background-color: var(--gob-bg);">
        ...
        <div class="p-4 row m-0" style="gap: 1.5rem; flex-shrink: 0;">
            <div class="col bg-white p-4 border shadow-sm d-flex align-items-center m-0"
                style="gap: 1.5rem; border-radius: 0;">
                ...
                <div>
                    <p class="text-muted font-weight-bold text-uppercase mb-1"
                        style="font-size: 10px; letter-spacing: 0.1em;">Total Votación</p>
            ...
            <div class="col bg-white p-4 border shadow-sm d-flex align-items-center m-0"
                ...
                <div>
                    <p class="text-muted font-weight-bold text-uppercase mb-1"
                        style="font-size: 10px; letter-spacing: 0.1em;">Priorizados</p>
            ...
            <div class="col bg-white p-4 border shadow-sm d-flex align-items-center m-0"
                ...
                <div>
                    <p class="text-muted font-weight-bold text-uppercase mb-1"
                        style="font-size: 10px; letter-spacing: 0.1em;">Sectores</p>
        ...
        <div class="flex-grow-1 p-4 pt-0">
            <div class="w-100 h-100 bg-white border shadow-sm position-relative overflow-hidden"
                ...
                <div class="position-absolute h-100 w-100 d-flex align-items-center justify-content-center">
                    <div class="text-center" style="max-width: 480px; padding: 2rem;">
                        ...
                        <p class="text-muted mb-4" style="font-size: 13px; line-height: 1.6;">Visualización de los 200
                            proyectos territoriales bajo norma de planificación zonal 2026.</p>
                        <button class="btn btn-dark px-5 py-3 font-weight-bold text-uppercase"
                            style="font-size: 10px; letter-spacing: 0.2em; border-radius: 0;">VER CAPAS
                            TÉCNICAS</button>
                    </div>
                </div>

                <!-- Marcadores -->
                <div class="position-absolute bg-primary border border-white shadow"
                    style="top: 25%; left: 33%; width: 20px; height: 20px; border-radius: 50%; border-width: 3px !important; z-index: 5;">
                </div>
                <div class="position-absolute bg-success border border-white shadow"
                    style="top: 50%; left: 50%; width: 16px; height: 16px; border-radius: 50%; border-width: 2px !important; z-index: 5;">
                </div>
                <div class="position-absolute bg-warning border border-white shadow"
                    style="bottom: 33%; right: 25%; width: 16px; height: 16px; border-radius: 50%; border-width: 2px !important; z-index: 5;">
                </div>
            </div>
        </div>
    </section>
...
<style>
    .project-card:hover {
        border-left: 4px solid var(--gob-primary) !important;
