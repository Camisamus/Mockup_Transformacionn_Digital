...
<header
    ...
    <div class="flex items-center gap-4 flex-1">
        <h2 class="text-lg font-bold tracking-tight">Perfil Detallado de Organización</h2>
    </div>
...
<div class="flex-1 overflow-y-auto custom-scrollbar p-6">
    <div class="max-w-7xl mx-auto space-y-6">
        <main class="flex-1 flex flex-col gap-6 p-8 overflow-y-auto">
            ...
            <!-- Profile Header Card -->
            <div
                class="bg-white dark:bg-[#1a2632] rounded-xl border border-[#dbe0e6] dark:border-[#2a343f] p-6 shadow-sm">
                <div class="flex flex-col @container">
                    <div class="flex w-full flex-col gap-6 @[520px]:flex-row @[520px]:justify-between">
                        <div class="flex gap-6">
                            <div class="bg-center bg-no-repeat aspect-square bg-cover rounded-xl h-28 w-28 border border-[#dbe0e6] dark:border-[#2a343f]"
                                data-alt="Entrepreneurship product showcase"
                            ...
                            <div class="flex flex-col justify-center">
                                <h2 class="text-[#111418] dark:text-white text-2xl font-bold leading-tight">Artesanías
                                    Mar del Plata</h2>
                                <div class="mt-2 space-y-1">
                                    <p class="text-[#617589] text-sm flex items-center gap-2">
                                        <span class="font-semibold text-[#111418] dark:text-gray-300">RUT:</span>
                                        77.654.321-K
                                        <span class="mx-2">|</span>
                                        <span class="font-semibold text-[#111418] dark:text-gray-300">Rubro:</span>
                                        Orfebrería
                                    </p>
                                    <p class="text-[#617589] text-sm flex items-center gap-2">
                                        <span
                                            class="font-semibold text-[#111418] dark:text-gray-300">Representante:</span>
                                        Juan Pérez Soto
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="flex items-center gap-3">
                            <button
                                class="flex items-center justify-center rounded-lg h-10 px-5 bg-background-light dark:bg-[#2a343f] text-[#111418] dark:text-white text-sm font-bold hover:bg-gray-200 dark:hover:bg-[#364350] transition-colors">
                                <span class="material-symbols-outlined mr-2 text-[18px]">arrow_back</span>
                                Volver
                            </button>
                            <button
                                class="flex items-center justify-center rounded-lg h-10 px-5 bg-red-500 text-white text-sm font-bold hover:bg-red-600 transition-colors shadow-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div
                    class="flex flex-1 items-center gap-4 rounded-xl p-6 border border-[#dbe0e6] dark:border-[#2a343f] bg-white dark:bg-[#1a2632]">
                    <div
                        class="size-12 rounded-full bg-yellow-100 dark:bg-yellow-900/30 flex items-center justify-center text-yellow-600">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span
                                class="text-[#078838] text-xs font-bold bg-[#e7f6ed] dark:bg-[#078838]/20 px-2 py-0.5 rounded-full">+0.2%</span>
                        </div>
                ...
                <div
                    class="flex flex-1 items-center gap-4 rounded-xl p-6 border border-[#dbe0e6] dark:border-[#2a343f] bg-white dark:bg-[#1a2632]">
                    <div
                        class="size-12 rounded-full bg-blue-100 dark:bg-primary/20 flex items-center justify-center text-primary">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span
                                class="text-[#078838] text-xs font-bold bg-[#e7f6ed] dark:bg-[#078838]/20 px-2 py-0.5 rounded-full">+5.0%</span>
                        </div>
            ...
            <div
                class="bg-white dark:bg-[#1a2632] rounded-xl border border-[#dbe0e6] dark:border-[#2a343f] overflow-hidden shadow-sm">
                <!-- Tabs Header -->
                <div class="flex border-b border-[#f0f2f4] dark:border-[#2a343f] px-6">
                    <button class="px-4 py-4 text-sm font-bold text-primary border-b-2 border-primary">Historial de
                        Inscripciones</button>
                    <button
                        class="px-4 py-4 text-sm font-medium text-[#617589] hover:text-[#111418] dark:hover:text-white">Registro
                        de Asistencia</button>
                    <button
                        class="px-4 py-4 text-sm font-medium text-[#617589] hover:text-[#111418] dark:hover:text-white">Evaluaciones
                        Recibidas</button>
                </div>
                        ...
                        <table class="w-full text-left border-collapse">
                            <thead>
                                <tr class="border-b border-[#f0f2f4] dark:border-[#2a343f]">
                                    <th class="py-3 px-4 text-xs font-bold uppercase tracking-wider text-[#617589]">
                                        Fecha</th>
                                    <th class="py-3 px-4 text-xs font-bold uppercase tracking-wider text-[#617589]">
                                        Evento / Plaza</th>
                                    <th class="py-3 px-4 text-xs font-bold uppercase tracking-wider text-[#617589]">
                                        Estado</th>
                                    <th
                                        class="py-3 px-4 text-xs font-bold uppercase tracking-wider text-[#617589] text-right">
                                        Acciones</th>
                                </tr>
                            </thead>
                ...
                <div class="p-6 pt-0">
                        ...
                        <table class="w-full text-left border-collapse">
                            <thead>
                                <tr class="border-b border-[#f0f2f4] dark:border-[#2a343f]">
                                    ...
                                    <th class="py-3 px-4 text-xs font-bold uppercase tracking-wider text-[#617589]">
                                        Asistencia</th>
                                    <th class="py-3 px-4 text-xs font-bold uppercase tracking-wider text-[#617589]">Nota
                                        Rúbrica</th>
                                    <th class="py-3 px-4 text-xs font-bold uppercase tracking-wider text-[#617589]">
                                        Comentarios</th>
                                </tr>
                            ...
                            <tbody class="divide-y divide-[#f0f2f4] dark:divide-[#2a343f]">
                                <tr class="hover:bg-background-light dark:hover:bg-[#2a343f] transition-colors">
                                    ...
                                    <td class="py-4 px-4 text-sm text-[#617589] italic">Excelente disposición y calidad
                                        del producto...</td>
                                </tr>
                                <tr class="hover:bg-background-light dark:hover:bg-[#2a343f] transition-colors">
                                    ...
                                    <td class="py-4 px-4 text-sm text-[#617589] italic">Presentación impecable del
                                        stand.</td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div
                        class="mt-8 p-4 rounded-lg bg-background-light dark:bg-[#2a343f] border border-[#dbe0e6] dark:border-[#2a343f] flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            <span class="material-symbols-outlined text-primary">info</span>
                            <p class="text-sm text-[#617589]">Para ver más detalles, descargue el <strong>Expediente
                                    PDF</strong> consolidado.</p>
                        </div>
