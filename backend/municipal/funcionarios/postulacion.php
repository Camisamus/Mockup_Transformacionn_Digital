...
?>
<header
    class="h-20 flex items-center justify-between border-b border-[#dbe0e6] dark:border-slate-800 bg-white dark:bg-slate-900 px-8 shrink-0 z-10">
    <div class="flex items-center gap-6 flex-1">
        <a href="pendientes.php"
            class="p-2 -ml-2 rounded-full hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors text-[#617589]">
    ...
    <div class="flex items-center gap-3">
        <button onclick="rejectPostulation()"
            class="flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-black text-danger hover:bg-danger/10 transition-all border border-transparent hover:border-danger/20">
            <span class="material-symbols-outlined text-lg">block</span>
            RECHAZAR
        </button>
        <button onclick="approvePostulation()"
            class="flex items-center gap-2 px-6 py-2.5 rounded-xl text-xs font-black bg-success text-white hover:bg-emerald-600 transition-all shadow-lg shadow-success/30">
            <span class="material-symbols-outlined text-lg">verified</span>
            APROBAR POSTULACIÓN
        </button>
        <div class="w-px h-8 bg-[#dbe0e6] dark:bg-slate-800 mx-2"></div>
        <button
            class="p-2.5 rounded-xl bg-slate-50 dark:bg-slate-800 text-[#617589] hover:text-primary transition-all border border-[#dbe0e6] dark:border-slate-700">
...
<div class="flex-1 overflow-y-auto custom-scrollbar p-8">
    <div class="max-w-6xl mx-auto space-y-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <section class="section-card">
                ...
                <div class="grid grid-cols-2 gap-y-6 gap-x-4">
                    ...
                    <div>
                        <label class="block text-[10px] font-bold text-[#617589] uppercase mb-1">Correo
                            Electrónico</label>
                        <p class="text-sm font-semibold">carolina.valdivia@email.com</p>
                    </div>
                    <div>
                        <label class="block text-[10px] font-bold text-[#617589] uppercase mb-1">Teléfono de
                            Contacto</label>
                        <p class="text-sm font-semibold">+56 9 8472 1192</p>
                    </div>
                    <div class="col-span-2">
                        <label class="block text-[10px] font-bold text-[#617589] uppercase mb-1">Dirección
                            Particular</label>
            ...
            <section class="section-card">
                ...
                <div class="grid grid-cols-2 gap-y-6 gap-x-4">
                    ...
                    <div>
                        <label class="block text-[10px] font-bold text-[#617589] uppercase mb-1">Rubro /
                            Categoría</label>
                        <span
                            class="inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-primary/10 text-primary uppercase">Artesanía
                            Manual</span>
                    </div>
                    <div>
                        <label class="block text-[10px] font-bold text-[#617589] uppercase mb-1">Años de
                            Actividad</label>
                        <p class="text-sm font-semibold">4 años</p>
                    </div>
                    <div class="col-span-2">
                        <label class="block text-[10px] font-bold text-[#617589] uppercase mb-1">Descripción de
                            Productos</label>
                        <p class="text-sm text-[#4a5568] dark:text-slate-300 leading-relaxed">
                            Confección de artículos decorativos a base de madera reciclada y conchas recolectadas en el
                            borde costero de la V Región. Proceso 100% artesanal y sustentable.
                        </p>
                    </div>
                </div>
            </section>
        ...
        <section class="section-card">
            <div
                class="flex items-center justify-between mb-6 border-b border-background-light dark:border-slate-800 pb-4">
                <div class="flex items-center gap-3">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-4 gap-4">
                <div
                    class="border border-[#dbe0e6] dark:border-slate-800 rounded-lg overflow-hidden group hover:border-primary/50 transition-colors">
                    <div class="aspect-[4/3] bg-slate-100 dark:bg-slate-800 flex items-center justify-center relative">
                        ...
                        <div
                            class="absolute inset-0 bg-primary/0 group-hover:bg-primary/5 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all">
        ...
        <section class="section-card">
            ...
            <div
                class="relative pl-8 space-y-8 before:absolute before:left-[11px] before:top-2 before:bottom-2 before:w-0.5 before:bg-[#dbe0e6] dark:before:bg-slate-800">
                <div class="relative">
                    <div
                        class="absolute -left-[27px] top-1.5 size-3.5 rounded-full border-2 border-white dark:border-slate-900 bg-primary">
                    </div>
                    <div class="flex flex-col gap-1">
                        ...
                        <p class="text-xs text-[#617589]">Ingresada exitosamente a través del portal ciudadano por el
                            usuario.</p>
                    </div>
                </div>
                <div class="relative">
                    <div
                        class="absolute -left-[27px] top-1.5 size-3.5 rounded-full border-2 border-white dark:border-slate-900 bg-warning">
                    </div>
                    <div class="flex flex-col gap-1">
                        <div class="flex items-center gap-3">
                        ...
                        <p class="text-xs text-[#617589]">Asignada automáticamente al departamento de Fomento
                            Productivo.</p>
                        <div
                            class="mt-2 p-3 bg-slate-50 dark:bg-slate-800/50 rounded-lg text-xs italic text-[#617589] border border-slate-200 dark:border-slate-800">
                            "Documentación inicial parece completa, proceder a verificar vigencia de patente municipal."
                            - Asignado a Depto. Jurídico.
                        </div>
                    </div>
                </div>
                <div class="relative">
                    <div
                        class="absolute -left-[27px] top-1.5 size-3.5 rounded-full border-2 border-white dark:border-slate-900 bg-slate-400">
                    </div>
                    <div class="flex flex-col gap-1">
                        <div class="flex items-center gap-3">
