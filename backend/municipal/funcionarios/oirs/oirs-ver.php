...
<div class="bg-white border-bottom px-4 py-3 sticky-top z-index-100">
    <div class="d-flex align-items-center justify-content-between">
        <div class="d-flex flex-column">
            <h2 class="h6 font-serif font-bold text-dark mb-0">
        ...
        <div class="d-flex" style="gap: 10px;">
            <button onclick="window.print()" class="btn btn-outline-secondary btn-sm d-flex align-items-center">
                <span class="material-symbols-outlined mr-1" style="font-size: 16px;">print</span> Resp. Contribuyente
            </button>

            <button onclick="window.print()" class="btn btn-outline-secondary btn-sm d-flex align-items-center">
                <span class="material-symbols-outlined mr-1" style="font-size: 16px;">print</span> Expediente Técnico
            </button>

            <a href="consulta.php" class="btn btn-primary btn-sm d-flex align-items-center">
                <span class="material-symbols-outlined mr-1" style="font-size: 16px;">arrow_back</span> Volver
            </a>
        </div>
    </div>
</div>
