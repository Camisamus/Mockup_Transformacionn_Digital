    ...
    <div class="d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center">
            ...
            <div class="d-flex flex-column">
                <h2 class="h6 font-serif font-bold text-dark mb-0">Consulta General de OIRS</h2>
                <p class="text-primary font-weight-bold text-uppercase mb-0" 
                style="font-size: 9px; letter-spacing: 0.15em; margin-top: 2px;">Buscador Inteligente de Solicitudes</p>
            </div>
        </div>
