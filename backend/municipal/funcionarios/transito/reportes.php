...
<div class="bg-white border-bottom px-4 py-3 sticky-top z-index-100">
    <div class="d-flex align-items-center justify-content-between">
        <div class="d-flex flex-column">
            <h2 class="h6 font-serif font-bold text-dark mb-0">Reportes de Gestión</h2>
            <p class="text-primary font-weight-bold text-uppercase mb-0" style="font-size: 9px; letter-spacing: 0.15em;">Estadísticas de Licencias de Conducir</p>
        </div>
        <div class="d-flex align-items-center" style="gap: 15px;">
             <div class="input-group input-group-sm bg-light rounded px-2 border">
                <span class="input-group-text bg-transparent border-0 font-weight-bold text-muted small">Desde</span>
                <input type="date" class="form-control border-0 bg-transparent font-weight-bold" value="<?php echo date('Y-m-01'); ?>">
                 <span class="input-group-text bg-transparent border-0 font-weight-bold text-muted small">Hasta</span>
                <input type="date" class="form-control border-0 bg-transparent font-weight-bold" value="<?php echo date('Y-m-d'); ?>">
            </div>
            <button class="btn btn-outline-success btn-sm font-weight-bold px-3"><span class="material-symbols-outlined align-middle mr-1">download</span> Exportar Excel</button>
        </div>
    </div>
</div>
                    ...
                    <div class="table-responsive">
                         <table class="table table-hover mb-0" style="font-size: 13px;">
                            <thead class="bg-light">
                                <tr>
                                    <th class="border-0 font-weight-bold text-muted text-uppercase py-3 pl-4">Trámite</th>
                                    <th class="border-0 font-weight-bold text-muted text-uppercase py-3 text-center">Solicitudes</th>
                                    <th class="border-0 font-weight-bold text-muted text-uppercase py-3 text-center">Atendidos</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
