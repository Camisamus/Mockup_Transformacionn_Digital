...
<form action="registro_guardar.php" method="POST" enctype="multipart/form-data">
    ...
    <main class="flex-1 max-w-[1024px] mx-auto w-full py-10 px-6">
        <div class="mb-10">
            <div class="flex justify-between items-end mb-6 px-2">
                <div>
                    ...
                    <p class="text-gray-500 dark:text-gray-400 mt-1">Siga los pasos para formalizar su actividad en la
                        comuna.</p>
                </div>
            ...
            <div class="relative mb-8">
                <div
                    class="absolute top-1/2 left-0 w-full h-1 bg-gray-200 dark:bg-gray-800 -translate-y-1/2 rounded-full overflow-hidden">
                    <div class="bg-primary h-full transition-all duration-500" style="width: 25%;" id="progress-bar">
                    </div>
                </div>
                <div class="relative flex justify-between">
                    <!-- Step 1 Indicator -->
                    <div class="flex flex-col items-center">
                        <div class="w-8 h-8 bg-primary text-white rounded-full flex items-center justify-center text-sm font-bold ring-4 ring-white dark:ring-background-dark step-circle transition-colors duration-300"
                            data-step="1">1</div>
                        <span
                            class="text-[10px] font-bold mt-2 uppercase text-primary step-label transition-colors duration-300"
                            data-step="1">Categoría</span>
                    </div>
                    <!-- Step 2 Indicator -->
                    <div class="flex flex-col items-center">
                        <div class="w-8 h-8 bg-gray-200 dark:bg-gray-800 text-gray-500 rounded-full flex items-center justify-center text-sm font-bold ring-4 ring-white dark:ring-background-dark step-circle transition-colors duration-300"
                            data-step="2">2</div>
                        <span
                            class="text-[10px] font-bold mt-2 uppercase text-gray-400 step-label transition-colors duration-300"
                            data-step="2">Negocio</span>
                    </div>
                    <!-- Step 3 Indicator -->
                    <div class="flex flex-col items-center">
                        <div class="w-8 h-8 bg-gray-200 dark:bg-gray-800 text-gray-500 rounded-full flex items-center justify-center text-sm font-bold ring-4 ring-white dark:ring-background-dark step-circle transition-colors duration-300"
        ...
        <div
            class="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 overflow-hidden min-h-[400px]">
            ...
            <div class="p-8 step-content block" id="step-content-1">
                <div class="mb-6">
                    <div class="flex items-center gap-2 mb-2">
                        ...
                        <span
                            class="text-[10px] bg-red-100 text-red-600 px-2 py-0.5 rounded-full font-bold uppercase">Obligatorio</span>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <!-- Option 1 -->
                    <label
                        class="group cursor-pointer border-2 border-transparent bg-gray-50 dark:bg-gray-800/50 rounded-xl p-6 transition-all hover:border-primary/50 hover:bg-primary/5 relative overflow-hidden has-[:checked]:border-primary has-[:checked]:bg-primary/5 category-card">
                        <input type="radio" name="categoria" value="alimentos" class="hidden peer" checked>
                        <div
                            class="absolute top-3 right-3 text-primary opacity-0 peer-checked:opacity-100 transition-opacity">
                            <span class="material-symbols-outlined">check_circle</span>
                        </div>
                        <div
                            class="w-12 h-12 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg flex items-center justify-center mb-4 group-hover:bg-primary group-hover:text-white transition-colors peer-checked:bg-primary peer-checked:text-white">
                            <span class="material-symbols-outlined text-2xl">restaurant</span>
                        </div>
                        <h3 class="font-bold text-lg mb-1">Alimentos</h3>
                        <p class="text-sm text-gray-600 dark:text-gray-400">Comida preparada, snacks, productos
                            orgánicos.</p>
                    </label>
                    ...
                    <label
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400">Diseño, Lectoría, peluquería, gasfitería.
                        </p>
                    </label>
                ...
                <div class="max-w-2xl mx-auto space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input name="rut_empresa"
                                class="w-full px-4 py-3 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-primary outline-none transition-all font-medium"
                                placeholder="76.123.456-7" />
                        </div>
                        <div>
                            <label class="block text-xs font-bold text-gray-400 mb-1 uppercase">Nombre de
                                Fantasía</label>
                    ...
                    <div>
                        <label class="block text-xs font-bold text-gray-400 mb-1 uppercase">Descripción /
                            Presentación</label>
                        <textarea name="descripcion" rows="4"
                            class="w-full px-4 py-3 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-primary outline-none transition-all font-medium resize-none"
                            placeholder="Describa brevemente su negocio, sus productos y qué lo hace único..."></textarea>
                    </div>

                    <!-- Logo Section Corrected Alignment -->
                    <div
                        class="flex flex-col md:flex-row items-center justify-between p-4 border-2 border-dashed border-primary/30 rounded-xl bg-primary/5 gap-4">
                        ...
                        <label
                            class="cursor-pointer bg-primary text-white px-5 py-2 rounded-lg text-xs font-bold flex items-center gap-2 hover:bg-primary/90 transition-all shadow-sm">
            ...
            <div class="p-8 step-content hidden" id="step-content-3">
                ...
                <div class="max-w-2xl mx-auto space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-xs font-bold text-gray-400 mb-1 uppercase">Correo
                                Electrónico</label>
                    ...
                    <div>
                        <label class="block text-xs font-bold text-gray-400 mb-1 uppercase">Organización
                            (Opcional)</label>
                        <input name="organizacion"
                            class="w-full px-4 py-3 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-primary outline-none transition-all font-medium"
                            placeholder="Junta de Vecinos, Asociación, etc." />
                    </div>
                    <div>
            ...
            <div class="p-8 step-content hidden" id="step-content-4">
                ...
                <div class="max-w-2xl mx-auto space-y-4">
                    <!-- Doc 1 -->
                    <div
                        class="flex items-center justify-between p-4 border border-gray-200 dark:border-gray-700 rounded-xl bg-white dark:bg-gray-900">
                        <div class="flex items-center gap-4">
                        ...
                        <div class="flex items-center gap-3">
                            <span
                                class="text-[10px] font-bold text-green-600 bg-green-50 dark:bg-green-900/20 px-2 py-1 rounded border border-green-100 dark:border-green-900/30">CARGADO</span>
                        </div>
                    </div>

                    <!-- Doc 2 -->
                    <div
                        class="flex items-center justify-between p-4 border-2 border-dashed border-primary/30 rounded-xl bg-primary/5">
                        <div class="flex items-center gap-4">
                        ...
                        <label class="cursor-pointer">
                            <span
                                class="bg-white text-primary px-3 py-1.5 rounded border border-gray-200 text-xs font-bold hover:bg-gray-50">EXAMINAR</span>
            ...
            <!-- Footer Control -->
            <div
                class="p-6 bg-gray-50 dark:bg-gray-900/50 border-t border-gray-100 dark:border-gray-800 flex justify-between items-center">
                <button type="button" id="prev-btn"
                    class="px-6 py-2.5 rounded-lg text-sm font-bold text-gray-500 hover:text-gray-700 hover:bg-gray-100 transition-all invisible">
                ...
                <button type="button" id="next-btn"
                    class="px-8 py-2.5 rounded-lg text-sm font-bold bg-primary text-white hover:bg-primary/90 transition-all shadow-lg shadow-primary/20 flex items-center gap-2">
                    Siguiente
                    <span class="material-symbols-outlined text-lg">arrow_forward</span>
                </button>

                <a href="reservar.php" id="submit-btn"
                    class="hidden px-8 py-2.5 rounded-lg text-sm font-bold bg-green-600 text-white hover:bg-green-700 transition-all shadow-lg shadow-green-600/20 flex items-center gap-2">
                    Finalizar Registro
